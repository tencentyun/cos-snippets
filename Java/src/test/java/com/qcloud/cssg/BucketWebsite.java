...
public class BucketWebsite {
     ...
     * 设置存储桶静态网站
     */
    public void putBucketWebsite() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶静态网站
     */
    public void getBucketWebsite() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 删除存储桶静态网站
     */
    public void deleteBucketWebsite() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketWebsite example = new BucketWebsite();
        example.initClient();

        // 设置存储桶静态网站
        example.putBucketWebsite();

        // 获取存储桶静态网站
        example.getBucketWebsite();

        // 删除存储桶静态网站
        example.deleteBucketWebsite();
