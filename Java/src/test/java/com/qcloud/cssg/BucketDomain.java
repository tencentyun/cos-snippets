...
public class BucketDomain {
     ...
     * 设置存储桶自定义域名
     */
    public void putBucketDomain() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶自定义域名
     */
    public void getBucketDomain() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketDomain example = new BucketDomain();
        example.initClient();

        // 设置存储桶自定义域名
        example.putBucketDomain();

        // 获取存储桶自定义域名
        example.getBucketDomain();
