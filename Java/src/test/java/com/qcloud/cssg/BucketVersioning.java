...
public class BucketVersioning {
     ...
     * 设置存储桶多版本
     */
    public void putBucketVersioning() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶多版本状态
     */
    public void getBucketVersioning() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketVersioning example = new BucketVersioning();
        example.initClient();

        // 设置存储桶多版本
        example.putBucketVersioning();

        // 获取存储桶多版本状态
        example.getBucketVersioning();
