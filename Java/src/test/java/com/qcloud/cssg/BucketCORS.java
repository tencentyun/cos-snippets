...
public class BucketCORS {
     ...
     * 设置存储桶跨域规则
     */
    public void putBucketCors() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶跨域规则
     */
    public void getBucketCors() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 删除存储桶跨域规则
     */
    public void deleteBucketCors() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketCORS example = new BucketCORS();
        example.initClient();

        // 设置存储桶跨域规则
        example.putBucketCors();

        // 获取存储桶跨域规则
        example.getBucketCors();

        // 删除存储桶跨域规则
        example.deleteBucketCors();
