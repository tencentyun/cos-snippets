...
public class BucketInventory {
     ...
     * 设置存储桶清单任务
     */
    public void putBucketInventory() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶清单任务
     */
    public void getBucketInventory() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 列出所有存储桶清单任务
     */
    public void listBucketInventory() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 删除存储桶清单任务
     */
    public void deleteBucketInventory() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketInventory example = new BucketInventory();
        example.initClient();

        // 设置存储桶清单任务
        example.putBucketInventory();

        // 获取存储桶清单任务
        example.getBucketInventory();

        // 列出所有存储桶清单任务
        example.listBucketInventory();

        // 删除存储桶清单任务
        example.deleteBucketInventory();
