...
public class BucketTagging {
     ...
     * 设置存储桶标签
     */
    public void putBucketTagging() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 获取存储桶标签
     */
    public void getBucketTagging() throws InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * 删除存储桶标签
     */
    public void deleteBucketTagging() throws InterruptedException, IOException, NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws InterruptedException, IOException,        NoSuchAlgorithmException {
        BucketTagging example = new BucketTagging();
        example.initClient();

        // 设置存储桶标签
        example.putBucketTagging();

        // 获取存储桶标签
        example.getBucketTagging();

        // 删除存储桶标签
        example.deleteBucketTagging();
