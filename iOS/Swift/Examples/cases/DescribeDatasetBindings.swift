import QCloudCOSXML
import XCTest
class DescribeDatasetBindingsDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testDescribeDatasetBindings() {
		let request : QCloudDescribeDatasetBindingsRequest = QCloudDescribeDatasetBindingsRequest();
