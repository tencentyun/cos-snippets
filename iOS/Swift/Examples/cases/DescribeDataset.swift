import QCloudCOSXML
import XCTest
class DescribeDatasetDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testDescribeDataset() {
		let request : QCloudDescribeDatasetRequest = QCloudDescribeDatasetRequest();
