...
class PostVoiceSeparate: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
    ...
    func PostVoiceSeparate() {
        ...
        let input = QCloudInputVoiceSeparate()
        input.input = QCloudInputVoiceSeparateInput()
        input.input.object = "test.m3u8"
        input.operation = QCloudInputVoiceSeparateOperation()
        input.operation.templateId = "TemplateId"
        input.operation.output = QCloudInputVoiceSeparateOutput()
