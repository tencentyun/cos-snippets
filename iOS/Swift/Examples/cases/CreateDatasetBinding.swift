import QCloudCOSXML
import XCTest
class CreateDatasetBindingDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testCreateDatasetBinding() {
		let request : QCloudCreateDatasetBindingRequest = QCloudCreateDatasetBindingRequest();
		request.regionName = "COS_REGIONNAME";
		request.input = QCloudCreateDatasetBinding();
