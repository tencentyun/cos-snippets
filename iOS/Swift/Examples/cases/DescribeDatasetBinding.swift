import QCloudCOSXML
import XCTest
class DescribeDatasetBindingDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testDescribeDatasetBinding() {
		let request : QCloudDescribeDatasetBindingRequest = QCloudDescribeDatasetBindingRequest();
