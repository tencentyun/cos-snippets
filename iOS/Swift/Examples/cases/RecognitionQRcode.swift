...
class RecognitionQRcodeDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testRecognitionQRcode() {
			let request : QCloudRecognitionQRcodeRequest = QCloudRecognitionQRcodeRequest();
		// 设置：objectKey;
