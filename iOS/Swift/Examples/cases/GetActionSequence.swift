...
class GetActionSequenceDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testGetActionSequence() {
			let request : QCloudGetActionSequenceRequest = QCloudGetActionSequenceRequest();
