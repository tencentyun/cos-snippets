import XCTest
import QCloudCOSXML
class AudioRecognition: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
    ...
    // 提交审核任务
    func putAudioRecognition() {
        //.cssg-snippet-body-start:[swift-put-audio-recognition]
    ...
    // 查询审核任务
    func getAudioRecognitionResult() {
        //.cssg-snippet-body-start:[swift-get-Audio-recognition]
