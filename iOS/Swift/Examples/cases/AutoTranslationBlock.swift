...
class AutoTranslationBlockDemo: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
	...
	func testAutoTranslationBlock() {
			let request : QCloudAutoTranslationBlockRequest = QCloudAutoTranslationBlockRequest();
