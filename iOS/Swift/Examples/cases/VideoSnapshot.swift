...
class VideoSnapshot: XCTestCase,QCloudSignatureProvider,QCloudCredentailFenceQueueDelegate{
    ...
    func VideoSnapshot() {
        ...
        let input = QCloudInputVideoSnapshot()
        input.input = QCloudInputVideoSnapshotInput()
        input.input.object = "test.m3u8"
        input.operation = QCloudInputVideoSnapshotOperation()
        input.operation.templateId = "TemplateId"
        input.operation.output = QCloudInputVideoSnapshotOperationOutput()
