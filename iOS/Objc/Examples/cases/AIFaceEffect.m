...
- (void) testAIFaceEffect{
	QCloudAIFaceEffectRequest * request = [QCloudAIFaceEffectRequest new];
	...
	request.age = 0;
	[request setFinishBlock:^(QCloudAIFaceEffectResponse * outputObject, NSError *error) {
		// result：QCloudAIFaceEffectResponse 包含所有的响应；
		// 具体查看代码注释或api文档：https://cloud.tencent.com/document/product/460/47197
	}];
	[[QCloudCOSXMLService defaultCOSXML] AIFaceEffect:request];
