...
@interface RecognitionQRcodeDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation RecognitionQRcodeDemo
...
- (void) testRecognitionQRcode{
	QCloudRecognitionQRcodeRequest * request = [QCloudRecognitionQRcodeRequest new];
