...
#import <QCloudCOSXML/QCloudCIBodyRecognitionRequest.h>
@interface BodyOperation : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation BodyOperation
