...
#import <QCloudCOSXML/QCloudGetActionSequenceRequest.h>

@interface GetActionSequenceDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation GetActionSequenceDemo
