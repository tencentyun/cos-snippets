...
#import <QCloudCOSXML/QCloudUpdateFileMetaIndexRequest.h>
#import <QCloudCOSXML/QCloudCOSXMLService+MateData.h>
@interface UpdateFileMetaIndexDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation UpdateFileMetaIndexDemo
...
- (void) testUpdateFileMetaIndex{
    ...
    request.input.File.CustomLabels = @{@"test":@"test"};
