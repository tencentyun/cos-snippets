...
#import <QCloudCOSXML/QCloudCIAutoTranslationRequest.h>
@interface TranslationOperation : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation TranslationOperation
