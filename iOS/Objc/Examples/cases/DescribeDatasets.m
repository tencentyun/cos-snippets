...
#import <QCloudCOSXML/QCloudDescribeDatasetsRequest.h>
#import <QCloudCOSXML/QCloudCOSXMLService+MateData.h>
@interface DescribeDatasetsDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation DescribeDatasetsDemo
