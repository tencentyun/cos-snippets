...
#import <QCloudCOSXML/QCloudCIImageRepairRequest.h>
@interface ImageRepairOperation : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation ImageRepairOperation
