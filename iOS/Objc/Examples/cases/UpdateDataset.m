...
#import <QCloudCOSXML/QCloudUpdateDatasetRequest.h>
#import <QCloudCOSXML/QCloudCOSXMLService+MateData.h>
@interface UpdateDatasetDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation UpdateDatasetDemo
