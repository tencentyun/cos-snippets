...
#import <QCloudCOSXML/QCloudPostSmartCoverRequest.h>
@interface PostSmartCover : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation PostSmartCover
