...
#import <QCloudCOSXML/QCloudPostSpeechRecognitionTempleteRequest.h>

@interface PostSpeechRecognitionTempleteDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation PostSpeechRecognitionTempleteDemo
...
- (void) testPostSpeechRecognitionTemplete{
