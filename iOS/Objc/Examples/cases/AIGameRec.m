...
#import <QCloudCOSXML/QCloudAIGameRecRequest.h>

@interface AIGameRecDemo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation AIGameRecDemo
