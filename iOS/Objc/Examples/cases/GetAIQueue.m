...
- (void) testGetAIQueue{
	QCloudGetAIQueueRequest * request = [QCloudGetAIQueueRequest new];
	...
	request.pageSize = 0;
	[request setFinishBlock:^(QCloudGetAIQueueResponse * outputObject, NSError *error) {
		// result：QCloudGetAIQueueResponse 包含所有的响应；
		// 具体查看代码注释或api文档：https://cloud.tencent.com/document/product/460/79394
	}];
	[[QCloudCOSXMLService defaultCOSXML] GetAIQueue:request];
