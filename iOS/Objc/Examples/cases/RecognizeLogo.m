...
#import <QCloudCOSXML/QCloudCIRecognizeLogoRequest.h>
@interface RecognizeLogo : XCTestCase <QCloudSignatureProvider, QCloudCredentailFenceQueueDelegate>

@property (nonatomic) QCloudCredentailFenceQueue* credentialFenceQueue;

@end

@implementation RecognizeLogo
