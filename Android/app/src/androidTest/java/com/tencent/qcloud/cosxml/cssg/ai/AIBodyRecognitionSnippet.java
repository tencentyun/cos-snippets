...
public class AIBodyRecognitionSnippet {
    ...
    private void aIBodyRecognition() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIBodyRecognitionRequest request = new AIBodyRecognitionRequest(bucket);
        // 存储桶中的位置标识符，即对象键
        ...
        cosXmlService.aiBodyRecognitionAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 人体识别的结果
                // 详细字段请查看api文档或者SDK源码
                AIBodyRecognitionResult result = (AIBodyRecognitionResult) cosResult;
    ...
    @Test
    public void testAIBodyRecognition() {
        initService();
        aIBodyRecognition();
    }
}