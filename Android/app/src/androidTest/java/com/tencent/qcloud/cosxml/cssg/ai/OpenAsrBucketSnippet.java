...
public class OpenAsrBucketSnippet {
    ...
    private void openAsrBucket() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        OpenAsrBucketRequest request = new OpenAsrBucketRequest(bucket);
        ...
        ciService.openAsrBucketAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 开通智能语音服务的结果
                // 详细字段请查看api文档或者SDK源码
                OpenAsrBucketResult result = (OpenAsrBucketResult) cosResult;
