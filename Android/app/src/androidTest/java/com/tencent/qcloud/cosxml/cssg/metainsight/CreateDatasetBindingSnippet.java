...
public class CreateDatasetBindingSnippet {
    ...
    private void createDatasetBinding() {
		// APPID
		String appid = "1253000000";
		CreateDatasetBindingRequest request = new CreateDatasetBindingRequest(appid);
		...
		ciService.createDatasetBindingAsync(request, new CosXmlResultListener() {
		    ...
		    public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
				// result 绑定存储桶与数据集的结果
				// 详细字段请查看api文档或者SDK源码
				CreateDatasetBindingResult result = (CreateDatasetBindingResult) cosResult;
    ...
    @Test
    public void testCreateDatasetBinding() {
        initService();
