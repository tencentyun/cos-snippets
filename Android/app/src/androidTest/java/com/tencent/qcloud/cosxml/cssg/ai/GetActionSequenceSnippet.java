...
public class GetActionSequenceSnippet {
    ...
    private void getActionSequence() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        GetActionSequenceRequest request = new GetActionSequenceRequest(bucket);
        ...
        cosXmlService.getActionSequenceAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 获取动作顺序的结果
                // 详细字段请查看api文档或者SDK源码
                GetActionSequenceResult result = (GetActionSequenceResult) cosResult;
