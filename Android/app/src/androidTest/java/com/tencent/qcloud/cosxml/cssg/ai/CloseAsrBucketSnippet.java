...
public class CloseAsrBucketSnippet {
    ...
    private void closeAsrBucket() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        CloseAsrBucketRequest request = new CloseAsrBucketRequest(bucket);
        ...
        ciService.closeAsrBucketAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 关闭智能语音服务的结果
                // 详细字段请查看api文档或者SDK源码
                CloseAsrBucketResult result = (CloseAsrBucketResult) cosResult;
    ...
    @Test
    public void testCloseAsrBucket() {
        initService();
        closeAsrBucket();
    }
}