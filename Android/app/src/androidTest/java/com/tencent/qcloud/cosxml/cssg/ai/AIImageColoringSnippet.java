...
public class AIImageColoringSnippet {
    ...
    private void aIImageColoring() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIImageColoringRequest request = new AIImageColoringRequest(bucket);
        // 存储桶中的位置标识符，即对象键
    ...
    @Test
    public void testAIImageColoring() {
        initService();
        aIImageColoring();
    }
}