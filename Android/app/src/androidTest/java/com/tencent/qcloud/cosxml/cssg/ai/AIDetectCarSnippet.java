...
public class AIDetectCarSnippet {
    ...
    private void aIDetectCar() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIDetectCarRequest request = new AIDetectCarRequest(bucket, "folder/document.jpg");
        ...
        cosXmlService.aiDetectCarAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 车辆车牌识别的结果
                // 详细字段请查看api文档或者SDK源码
                AIDetectCarResult result = (AIDetectCarResult) cosResult;
