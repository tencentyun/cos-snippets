...
public class PostVoiceSeparateSnippet {
    ...
    private void postVoiceSeparate() {
		...
		// 设置存储结果的存储桶;是否必传：是
		output.bucket = "test-123456789";
		// 设置背景音结果文件名;是否必传：否
		output.object = "output/backgroud.${ext}";
		// 设置人声结果文件名;是否必传：否
		output.auObject = "output/audio.${ext}";
    ...
    @Test
    public void testPostVoiceSeparate() {
        initService();
        postVoiceSeparate();
    }
}