...
public class AIGameRecSnippet {
    ...
    private void aIGameRec() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIGameRecRequest request = new AIGameRecRequest(bucket);
        // 存储桶中的位置标识符，即对象键
        ...
        cosXmlService.aiGameRecAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 游戏场景识别的结果
                // 详细字段请查看api文档或者SDK源码
                AIGameRecResult result = (AIGameRecResult) cosResult;
