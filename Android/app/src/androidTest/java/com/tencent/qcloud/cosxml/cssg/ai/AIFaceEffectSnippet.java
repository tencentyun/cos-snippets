...
public class AIFaceEffectSnippet {
    ...
    private void aIFaceEffect() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIFaceEffectRequest request = new AIFaceEffectRequest(bucket);
        request.objectKey = "folder/image.jpg";
        ...
        cosXmlService.aiFaceEffectAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 人脸特效的结果
                // 详细字段请查看api文档或者SDK源码
                AIFaceEffectResult result = (AIFaceEffectResult) cosResult;
