...
public class CloseAIBucketSnippet {
    ...
    private void closeAIBucket() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        CloseAIBucketRequest request = new CloseAIBucketRequest(bucket);

        ciService.closeAIBucketAsync(request, new CosXmlResultListener() {
            @Override
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 关闭AI内容识别服务的结果
                // 详细字段请查看api文档或者SDK源码
                CloseAIBucketResult result = (CloseAIBucketResult) cosResult;
