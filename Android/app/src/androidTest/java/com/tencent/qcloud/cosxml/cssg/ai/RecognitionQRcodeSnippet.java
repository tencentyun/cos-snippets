...
public class RecognitionQRcodeSnippet {
    ...
    private void recognitionQRcode() {
        ...
        RecognitionQRcodeRequest request = new RecognitionQRcodeRequest(bucket, "folder/sample.jpg");
        request.cover = 0;// 设置二维码覆盖功能，将对识别出的二维码覆盖上马赛克。取值为0或1。0表示不开启二维码覆盖，1表示开启二维码覆盖，默认值0
        ...
        cosXmlService.recognitionQRcodeAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 图片二维码识别的结果
                // 详细字段请查看api文档或者SDK源码
                RecognitionQRcodeResult result = (RecognitionQRcodeResult) cosResult;
    ...
    @Test
    public void testRecognitionQRcode() {
        initService();
        recognitionQRcode();
    }
}