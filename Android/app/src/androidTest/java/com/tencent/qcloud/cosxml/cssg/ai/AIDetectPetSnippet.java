...
public class AIDetectPetSnippet {
    ...
    private void aIDetectPet() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIDetectPetRequest request = new AIDetectPetRequest(bucket, "folder/document.jpg");
        ...
        cosXmlService.aiDetectPetAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 宠物识别的结果
                // 详细字段请查看api文档或者SDK源码
                AIDetectPetResult result = (AIDetectPetResult) cosResult;
