...
public class GetLiveCodeSnippet {
    ...
    private void getLiveCode() {
        ...
        GetLiveCodeRequest request = new GetLiveCodeRequest(bucket);
        ...
        cosXmlService.getLiveCodeAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 获取数字验证码的结果
                // 详细字段请查看api文档或者SDK源码
                GetLiveCodeResult result = (GetLiveCodeResult) cosResult;
