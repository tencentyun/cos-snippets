...
public class GoodsMattingSnippet {
    ...
    private void goodsMatting() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        GoodsMattingRequest request = new GoodsMattingRequest(bucket, "folder/document.jpg");
        // 设置结果文件保存路径
