...
public class PostSpeechRecognitionTemplateSnippet {
    ...
    private void postSpeechRecognitionTemplate() {
    ...
    @Test
    public void testPostSpeechRecognitionTemplate() {
        initService();
        postSpeechRecognitionTemplate();
    }
}