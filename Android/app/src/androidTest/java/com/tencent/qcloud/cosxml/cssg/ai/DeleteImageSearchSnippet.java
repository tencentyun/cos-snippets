...
public class DeleteImageSearchSnippet {
    ...
    private void deleteImageSearch() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        DeleteImageSearchRequest request = new DeleteImageSearchRequest(bucket, "folder/image.jpg");
...
// 设置物品 ID;是否必传：是
    ...
    @Test
    public void testDeleteImageSearch() {
        initService();
        deleteImageSearch();
    }
}