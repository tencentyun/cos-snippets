...
public class AIIDCardOCRSnippet {
    ...
    private void aIIDCardOCR() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIIDCardOCRRequest request = new AIIDCardOCRRequest(bucket, "folder/document.jpg");
        ...
        cosXmlService.aiIDCardOCRAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 身份证识别的结果
                // 详细字段请查看api文档或者SDK源码
                AIIDCardOCRResult result = (AIIDCardOCRResult) cosResult;
