...
public class AssessQualitySnippet {
    ...
    private void assessQuality() {
        ...
        AssessQualityRequest request = new AssessQualityRequest(bucket, "folder/document.jpg");
        ...
        cosXmlService.assessQualityAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 图片质量评分的结果
                // 详细字段请查看api文档或者SDK源码
                AssessQualityResult result = (AssessQualityResult) cosResult;
