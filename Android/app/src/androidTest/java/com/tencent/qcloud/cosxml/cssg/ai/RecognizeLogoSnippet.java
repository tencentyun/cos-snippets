...
public class RecognizeLogoSnippet {
    ...
    private void recognizeLogo() {
        ...
        RecognizeLogoRequest request = new RecognizeLogoRequest(bucket);
        request.detectUrl = "http://www.example.com/abc.jpg";// 设置待检查图片url
        ...
        cosXmlService.recognizeLogoAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result Logo 识别的结果
                // 详细字段请查看api文档或者SDK源码
                RecognizeLogoResult result = (RecognizeLogoResult) cosResult;
