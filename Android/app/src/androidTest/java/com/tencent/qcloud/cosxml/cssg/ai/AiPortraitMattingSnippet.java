...
public class AiPortraitMattingSnippet {
    ...
    private void aiPortraitMatting() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AIPortraitMattingRequest request = new AIPortraitMattingRequest(bucket, "folder/PortraitMatting.jpg");
        // 抠图主体居中显示
        request.centerLayout = true;
        // 将处理后的图片四边进行留白
        request.paddingLayout = "10 x 10";
        // 设置结果文件保存路径
    ...
    @Test
    public void testAiPortraitMatting() {
        initService();
        aiPortraitMatting();
    }
}