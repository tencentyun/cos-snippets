...
public class AutoTranslationBlockSnippet {
    ...
    private void autoTranslationBlock() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        AutoTranslationBlockRequest request = new AutoTranslationBlockRequest(bucket);
        request.inputText = "待翻译的文本";// 设置待翻译的文本
        ...
        cosXmlService.autoTranslationBlockAsync(request, new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult cosResult) {
                // result 实时文字翻译的结果
                // 详细字段请查看api文档或者SDK源码
                AutoTranslationBlockResult result = (AutoTranslationBlockResult) cosResult;
    ...
    @Test
    public void testAutoTranslationBlock() {
        initService();
