...
public class ImageSearchBucketSnippet {
    ...
    private void imageSearchBucket() {
        // 存储桶名称，格式为 BucketName-APPID
        String bucket = "examplebucket-1250000000";
        ImageSearchBucketRequest request = new ImageSearchBucketRequest(bucket);
    ...
    @Test
    public void testImageSearchBucket() {
        initService();
        imageSearchBucket();
    }
}